// Enhanced by AI on 2025-08-17T10:29:06.815Z
// Section: hero
// Category: hero
        ...
        <div className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          ...
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-6">
              Elevate Your SAP Manufacturing
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
              Unlock the full potential of your SAP manufacturing processes with our cutting-edge consulting solutions.
              Transform your business and drive operational excellence.
            </p>
              ...
              <div className="rounded-2xl border bg-card p-2 shadow-2xl">
                <div className="rounded-xl bg-gradient-to-br from-muted/50 to-muted aspect-video flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-muted-foreground">SAP Manufacturing Consulting</p>
                  </div>
                </div>
              </div>
