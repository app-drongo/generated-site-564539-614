// Enhanced by AI on 2025-08-17T10:29:07.030Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    ...
    { value: "100+", label: "SAP Integrations", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join leading manufacturing companies who trust our SAP consulting services.
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Discuss your SAP needs with our experts
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Trusted SAP consulting with 99.9% uptime
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Seamless SAP implementation with expert support
              </p>
            </div>
          </div>
        </div>
